    ...
    <>
      ...
      <div className="flex flex-row justify-center w-full bg-gray-100">
        <div className="flex flex-row justify-between items-start w-full">
          ...
          <div className="h-[1070px] w-[85%] relative">
              ...
              <div className="flex flex-row justify-between items-center w-3/5">
                <div className="flex flex-row justify-between items-start w-2/5">
                  ...
                  <div className="flex flex-col items-center justify-start w-[18%] gap-[7px]">
                    ...
                    <div className="h-0.5 w-[82%] bg-gray-900" />
                  </div>
            ...
            <div className="flex flex-col items-center justify-start w-[29%] h-max gap-[30px] left-0 bottom-0 top-0 p-[30px] m-auto bg-white-A700 absolute rounded-[12px]">
            ...
            <div className="h-[1070px] w-[67%] right-0 bottom-0 top-0 m-auto absolute">
              <Img
              ...
              <div className="flex flex-col items-center justify-start w-[87%] bottom-0 right-0 left-0 m-auto absolute">
                <div className="justify-center w-full gap-4 grid-cols-3 grid min-h-[auto]">
                  <Img
                    src="images/img_image_221x221.png"
                    alt="image_one"
                    className="w-full object-cover rounded-[12px]"
                  />
                  <Img src="images/img_image_40.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                  <Img src="images/img_image_41.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                  <Img src="images/img_image_42.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                  <Img src="images/img_image_43.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                  <Img src="images/img_image_44.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                  <Img src="images/img_image_45.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                  <Img src="images/img_image_46.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                  <Img src="images/img_image_47.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                  <Img src="images/img_image_48.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                  <Img src="images/img_image_49.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                  <Img src="images/img_image_50.png" alt="image_one" className="w-full object-cover rounded-[12px]" />
                </div>
              </div>
            </div>
          </div>
