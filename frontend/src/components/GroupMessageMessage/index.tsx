        ...
        <div className="flex flex-row justify-start items-start w-[71%] gap-[15px]">
          <div className="flex flex-col items-center justify-start h-[51px] w-[51px]">
            <div className="flex flex-row justify-center w-full">
              <Img src={closeFriends} alt="close_friends" className="w-7 object-cover rounded-lg" />
              <Img src={closefriends1} alt="close_friends" className="w-7 ml-[-5px] object-cover rounded-lg" />
            </div>
            <Button
              color="gray_900"
              size="xs"
              className="mt-[-5px] font-sfprodisplay font-bold min-w-[28px] rounded-md"
            >
              {nine}
            </Button>
          </div>
